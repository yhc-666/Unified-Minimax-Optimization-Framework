...
from model import dr_jl_abc_l2_norm, dr_jl_abc_efb_l2_norm
import pandas as pd
...
def objective(trial):  
    ...
    log_epoch = my_model.fit(tb_log, x_all, obs, x_train_tensor, y_train_tensor, grad_type=args.grad_type, num_epochs=args.num_epochs, num_bins=args.num_bins, l2_norm=args.l2_norm, beta=args.beta, gamma=args.gamma, G=args.G, pred_lr=args.pred_lr, impu_lr=args.impu_lr, prop_lr=args.prop_lr2, pred_lamb=args.pred_lamb, impu_lamb=args.impu_lamb, prop_lamb=args.prop_lamb2, tol=args.tol)
...
if __name__ == '__main__':
    ...
    file_name = f"propensity_framework_{args.data_name}_{args.thres}{args.train_rate}{args.val_rate}_{args.debias_name}_{args.pred_model_name}_{args.impu_model_name}_{args.prop_model_name}_{args.abc_model_name}_ce_{args.load_param_type}_impu_copy{args.copy_model_pred}_{args.embedding_k}_grad_type{args.grad_type}_{args.num_epochs}_{args.tol}_{args.num_bins}_{args.l2_norm}_{args.batch_size_prop}_{args.batch_size}_{args.sever}_{args.device}_{args.seed}_optuna_tune_on_{args.tune_type}_{args.auc_type}_auc_ex{args.ex_idx}_revision"
