...
from model import dr_jl_abc, dr_jl_abc_free, dr_jl_abc_eqb, dr_jl_abc_eqb_free
import pandas as pd
...
def objective(trial):  
    if args.ex_idx == 1:
        ...
        args.dis_lr = trial.suggest_loguniform('dis_lr', 0.0005, 0.1)
        args.dis_lamb = trial.suggest_loguniform('dis_lamb', 1e-7, 10.0)
        ...
        args.dis_lr = trial.suggest_loguniform('dis_lr', 0.0005, 0.1)
        args.dis_lamb = trial.suggest_loguniform('dis_lamb', 1e-6, 1.0)
    ...
    if args.ex_idx == 41:
        ...
        args.dis_lr = trial.suggest_loguniform('dis_lr', 0.0005, 0.1)
        args.dis_lamb = trial.suggest_loguniform('dis_lamb', 1e-7, 1.0)
